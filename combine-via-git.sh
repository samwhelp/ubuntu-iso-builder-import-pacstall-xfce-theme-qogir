...
REF_WORK_DIR_PATH="${HOME}/work/ubuntu-iso-builder-import-pacstall-xfce-theme-qogir"
...
echo "[Next Step]: cd ~/work/ubuntu-iso-builder-import-pacstall-xfce-theme-qogir/iso-profile
"
echo
